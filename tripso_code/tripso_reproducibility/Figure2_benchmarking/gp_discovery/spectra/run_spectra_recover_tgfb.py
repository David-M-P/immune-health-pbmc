...
root_dir = f'tripso_reproducibility/05_gpfinder/spectra_repeat/recover_tgfb/seed_{SEED}'
...
gene_set_dict = {
    'TNFa': {
        'TNFa': gpdb['TNFa'].dropna().tolist()  # TNFa-specific gene set
    },
    'TGFb': {'TGFb_from_HVG' : adata.var_names[adata.var['highly_variable']].tolist()},  # Test Spectra's ability to recover TGFb
    'global': {
